...
export default function RainbowButton({ children, href, className = "" }: RainbowButtonProps) {
  ...
  const content = (
    <>
      ...
      <span className="relative z-[2] flex h-11 md:h-12 items-center gap-2 rounded-[10px] bg-[#15141a] px-4 md:px-6 py-2 md:py-3 text-base font-semibold text-white whitespace-nowrap">
        {children}
      </span>
